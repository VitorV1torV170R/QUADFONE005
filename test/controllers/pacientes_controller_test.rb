...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference("Paciente.count") do
      post pacientes_url, params: { paciente: { cliente_id: @paciente.cliente_id, idade: @paciente.idade, nome: @paciente.nome } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { cliente_id: @paciente.cliente_id, idade: @paciente.idade, nome: @paciente.nome } }
