...
class AtendimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atendimento" do
    assert_difference("Atendimento.count") do
      post atendimentos_url, params: { atendimento: { data: @atendimento.data, descricao: @atendimento.descricao, paciente_id: @atendimento.paciente_id, profissional_id: @atendimento.profissional_id, status: @atendimento.status } }
    end
  ...
  test "should update atendimento" do
    patch atendimento_url(@atendimento), params: { atendimento: { data: @atendimento.data, descricao: @atendimento.descricao, paciente_id: @atendimento.paciente_id, profissional_id: @atendimento.profissional_id, status: @atendimento.status } }
